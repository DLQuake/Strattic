...
function acf_block_render_callback_JobOffersInformation($block)
{
    ...
    $args = array(
        ...
        $crumbs[1] = array('link' => home_url().'/help-center/', 'text' => 'The team');
        $crumbs[2] = array('link' => '', 'text' => $category_name);
        $context['crumbs'] = $crumbs;
    Timber::render('./JobOffersInformation.block.view.twig', $context);
}